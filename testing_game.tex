...
\begin{tabular}{r | c | c | c }
	& $t = 1$ & $2 \leq t \leq K$ & $t > K$\\
\hline
$m_{\max} \leq K$ & P & P & NP-C\\
$m_{\max} > K$ & P & coNP-C & NP-H and coNP-H
\end{tabular}
\caption{\textsc{Optimal Test
Strategy} problem's complexity given a constant $K$ ($t, m_{\max}$: test size, max memory size)}
\label{tab:results}
\end{table}
