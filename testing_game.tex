...
%vc:UPDATE FIGURE, NO CAPACITY ZERO MIDDLE EDGES
\begin{figure}
...
\centering
	...
	\subfigure[Increasing $m_{max}$ with \newline $n = L = 150$.]{
	...
	\caption{Runtime for solving optimal one-question tests.}
\end{figure*}
...
on $U$ to a precision of $10^{-8}$ using (3) Edmonds-Karp \cite{Edmonds:1972:TIA:321694.321699} and (4)
Push-Relabel \cite{Goldberg:1988:NAM:48014.61051}, in each case combined with using
